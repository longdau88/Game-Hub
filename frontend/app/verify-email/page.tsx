      ...
      <div className="max-w-md w-full text-center space-y-6 bg-zinc-900/50 p-8 rounded-2xl border border-zinc-800 backdrop-blur-sm shadow-2xl">
        ...
        {status === "error" && (
          <>
            ...
            <p className="text-zinc-400">{message}</p>
            <div className="pt-4">
              <Link href="/login" className="px-6 py-2 bg-zinc-800 hover:bg-zinc-700 text-white border border-zinc-700 rounded-md font-medium transition-colors inline-block">
                Back to Login
              </Link>
            </div>
          </>
