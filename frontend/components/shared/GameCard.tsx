...
export function GameCard({ game }: { game: Game }) {
  return (
    <Card className="group relative flex flex-col overflow-hidden bg-surface transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/10 border-transparent hover:border-border cursor-pointer">
      ...
      <CardFooter className="flex items-center justify-between p-4 pt-0">
        ...
        <div className="flex items-center gap-3 text-sm text-muted-foreground">
          ...
          <button className="text-muted-foreground hover:text-primary transition-colors p-1 rounded-full hover:bg-primary/10">
